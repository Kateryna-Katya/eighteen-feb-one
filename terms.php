            ...
            <div class="legal-content">
                ...
                <div class="legal-section">
                    ...
                    <p>
                        ...
                        инновационным материалам, практикам применения ИИ, статьям в блоге и другим инструментам 
                        автоматизации и развития. Настоящее Соглашение регулирует все аспекты взаимодействия Пользователя с платформой.
                    </p>
                </div>
                ...
                <div class="legal-section">
                    ...
                    <ul class="legal-list">
                        ...
                        <li>Предоставлять недостоверную информацию при заполнении форм обратной связи.</li>
                    </ul>
                </div>
                ...
                <div class="legal-section">
                    ...
                    <div class="property-block">
                        <i data-lucide="copyright" class="property-icon"></i>
                        <p>
                            Весь контент на <strong><?= $fullDomain ?></strong> (тексты, код, графика, логотипы) является интеллектуальной собственностью Компании. 
                            Вам предоставляется ограниченная лицензия для личного некоммерческого использования в целях изучения ИИ. Копирование материалов без разрешения запрещено.
                        </p>
                    </div>
                </div>
                ...
                <div class="legal-section">
                    ...
                    <div class="warning-block">
                        <p>
                            Услуги и информация предоставляются по принципу <strong>«как есть» (as is)</strong>. Компания не несет ответственности за любые прямые или косвенные убытки, 
                            возникшие в результате использования технологий ИИ или невозможности доступа к платформе <strong><?= $domainTitle ?></strong>.
                        </p>
                    </div>
                </div>
                ...
                <div class="legal-section">
                    ...
                    <p>
                        Мы оставляем за собой право изменять данные Условия в любое время. Все споры стороны будут стремиться разрешить путем конструктивных переговоров в соответствии с законодательством ЕС. 
                        В случае недостижения согласия, спор подлежит рассмотрению по месту регистрации Компании в Италии.
                    </p>
                </div>
                ...
                <div class="contact-footer-policy">
                    ...
                    <div class="contact-data-block">
                        ...
                        <p class="policy-phone">+39 06 9764 4829</p>
