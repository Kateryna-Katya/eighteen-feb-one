        ...
        <div class="container">
            ...
            <div class="legal-content">
                <div class="legal-block">
                    <p>
                        <strong>Общая информация:</strong> Все материалы, статьи и сведения о практиках применения ИИ,
                        ...
                        рассматриваться как профессиональные технические рекомендации, 
                        юридический совет или призыв к автоматизации бизнес-процессов без предварительного аудита.
                    </p>
                </div>
                ...
                <div class="legal-block">
                    <p>
                        ...
                        относительно точности, полноты или актуальности представленной информации об ИИ-инструментах. 
                        Любые упоминания эффективности, экономии времени или программ пассивного дохода
                        не гарантируют аналогичных результатов для каждого пользователя.
                        Ваши итоги зависят от индивидуальных навыков и могут существенно отличаться.
                    </p>
                </div>
                ...
                <div class="legal-block">
                    <p>
                        ...
                        его владельцы и аффилированные лица в Италии и других странах ЕС не несут ответственности за
                        любые прямые или косвенные убытки, потерю данных или сбои, возникшие в результате
                        использования сторонних нейросетей и сервисов, описанных на этом ресурсе. 
                        Вся ответственность за внедрение предложенных методологий лежит исключительно на пользователе.
                    </p>
                </div>

                <div class="legal-block risk-warning">
                    <p>
                        <strong>Предупреждение о рисках:</strong> Использование инновационных технологий и систем ИИ сопряжено с
                        определенным уровнем неопределенности. Перед принятием
                        решений, влияющих на вашу профессиональную деятельность или финансы, мы настоятельно рекомендуем 
                        провести самостоятельное тестирование инструментов в безопасной среде.
                    </p>
                </div>
